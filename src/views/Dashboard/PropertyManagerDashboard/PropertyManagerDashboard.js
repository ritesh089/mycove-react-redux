			...
			<Col xs="12" sm="6" md="3">
				<Card>
					...
					<CardFooter className="px-3 py-2">
						<a className="font-weight-bold font-xs btn-block text-muted" href="#">Add More<i className="fa fa-plus float-right font-lg"></i></a>
					</CardFooter>
				</Card>
			</Col>
			<Col xs="12" sm="6" md="3">
			...
			<Col xs="12" sm="6" md="3">
				<Card>
					<CardBlock className="card-body clearfix p-3">
						...
						<div className="h5 mb-0 text-primary mt-2">5</div>
						<div className="text-muted text-uppercase font-weight-bold font-xs">Employees</div>
					</CardBlock>
					<CardFooter className="px-3 py-2">
